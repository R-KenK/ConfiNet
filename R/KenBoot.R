...
#' @param output desired output of the bootstrap: edge lists, adjacency matrices, association index matrices, or igraph graphs
#'
...
KenBoot<- function(Adj,effort,type = c("total","yab"),boot=100,replacement=TRUE,proportion=1.0,
                   ...
                   output=c("adjacency","edge","assoc","graph")){
  ...
  if(output %in% c("edge","adjacency","assoc","graph")){
